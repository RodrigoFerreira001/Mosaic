package dev.catbit.mosaic.sample.server.endpoints.screen.screens.home
...
object HomeScreenBuilder : ScreenBuilder {

    override fun canBuild(screenId: String) = screenId == "home"
