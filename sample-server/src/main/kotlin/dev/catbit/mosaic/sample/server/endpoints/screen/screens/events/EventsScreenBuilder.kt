...
private val eventCatalogEntries = listOf(
    ...
    CatalogEntry("RunCancellableEvents", "play_circle", "Events / Meta"),
    CatalogEntry("CancelEvents", "cancel", "Events / Meta"),
    ...
    CatalogEntry("StartTimeLoop", "loop", "Time"),
    ...
    CatalogEntry("OpenExternalLink", "open_in_new", "System"),
