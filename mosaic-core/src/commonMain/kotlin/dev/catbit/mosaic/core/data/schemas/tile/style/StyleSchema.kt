 ...
 * - `background` supports solid colors and linear/horizontal/vertical/radial/sweep gradients
 *   (see [BackgroundSchema]); blur is not implemented yet.
 */
@Immutable
@Serializable
data class StyleSchema(
    ...
    @SerialName("background") val background: BackgroundSchema? = null,
