...
/**
 * Renders a Material 3 `CircularProgressIndicator`. When [progress] is `null` the indicator is
 ...
 *
 * **Notes:** colors and stroke are Material defaults — only [style] (size, padding, background,
 * …) is applied. Drive a determinate indicator by pushing new [progress] values with
 * `UpdateTiles`.
 */
@Immutable
@Serializable
