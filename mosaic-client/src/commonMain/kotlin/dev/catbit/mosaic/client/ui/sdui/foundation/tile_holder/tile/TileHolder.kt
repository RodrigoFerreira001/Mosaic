...
import dev.catbit.mosaic.client.ui.sdui.foundation.tile_holder.UpdateScope
...
abstract class TileHolder<T : TileModel> {
    ...
    open fun getTileHolder(tileId: String): TileHolder<*>? =
        if (tileId == id) this
        else tiles?.firstNotNullOfOrNull { it.getTileHolder(tileId) }
