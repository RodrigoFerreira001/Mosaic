...
object DisplaySnackbarEventRunner : EventRunner<DisplaySnackbarEventSchema> {
    override suspend fun EventRunningScope.runEvent(event: DisplaySnackbarEventSchema) {
        ...
        val duration = when (event.duration) {
            DisplaySnackbarEventSchema.SnackbarDuration.Short -> SnackbarDuration.Short
            DisplaySnackbarEventSchema.SnackbarDuration.Long -> SnackbarDuration.Long
            DisplaySnackbarEventSchema.SnackbarDuration.Indefinite -> SnackbarDuration.Indefinite
        }
