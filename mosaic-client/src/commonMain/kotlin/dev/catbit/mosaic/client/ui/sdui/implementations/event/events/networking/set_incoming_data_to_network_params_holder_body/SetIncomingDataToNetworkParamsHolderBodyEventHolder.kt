...
class SetIncomingDataToNetworkParamsHolderBodyEventHolder(
    override val id: String,
    override var event: SetIncomingDataToNetworkParamsHolderBodyEventSchema,
    override val trigger: EventTrigger,
    override val events: List<EventHolder<*>>?,
    override val tiles: List<TileHolder<*>>? = null
) : EventHolder<SetIncomingDataToNetworkParamsHolderBodyEventSchema>() {
